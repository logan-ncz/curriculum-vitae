		...
		<div className="bloc_page">
			<aside>
				...
				<section className="a_propos_de_moi">
					...
					<div className="aside_container">
						<p>
							Développement Front-End spécialisé sur React.js, déterminé, motivé et curieux, je suis
				...
				<section className="loisirs">
					<h2>loisirs</h2>
					<p>
						<Dumbbell color="#d9b952" />
						<Gamepad color="#d9b952" />
					</p>
				</section>
			</aside>
			<section className="contenu">
				...
				<section className="diplomes_et_formations">
					...
					<p>
						<strong>
							Développeur Application JavaScript React - Bac +3/4 - diplôme enregistré au RNCP
						</strong>
						<br />
					...
					<div className="projets">
						...
						<ul>
							<li>
								<strong>Analyser les besoins</strong> à partir du cahier des charges défini par le
								client ou le chef de projet
							</li>
							<li>
							...
							<li>
								Communiquer avec les <strong>développeurs back-end</strong> pour assurer l’échange
							...
							<li>
								Utiliser des <strong>frameworks comme React</strong> pour construire des applications
								puissantes et modulaires
							</li>
							<li>
								<strong>Tester</strong> le bon fonctionnement de l’application et corriger le code quand
								c’est nécessaire
							</li>
							<li>
								Assurer le <strong>support technique</strong> du site et produire une{" "}
								<strong>documentation</strong> technique et fonctionnelle du site pour le client
							</li>
						</ul>
					</div>
				...
				<section className="experiences_professionnelles">
					...
					<div>
						<p>
							...
							<br />
							Agence Z&Ko Les Sables d'Olonne, France de Septembre 2022 à Aujourd'hui
						</p>
					</div>
				</section>
